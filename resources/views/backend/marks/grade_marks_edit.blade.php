...
<section class="content">
 ...
 <input type="text" name="grade_name" class="form-control" required="" value="{{ $editData->grade_name }}" >
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="grade_point" class="form-control" required="" value="{{ $editData->grade_point }}" >
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="start_marks" class="form-control" required="" value="{{ $editData->start_marks }}">
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="end_marks" class="form-control" required="" value="{{ $editData->end_marks }}"  >
	  </div>
	  </div>
	...
	<div class="col-md-4">
 	 ...
 	 <div class="form-group">
		...
		<div class="controls">
	 <input type="number" name="start_point" class="form-control" required="" value="{{ $editData->start_point }}"  >
	  </div>
	  </div>
...
<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="end_point" class="form-control" required=""  value="{{ $editData->end_point }}">
	  </div>
	  </div>
