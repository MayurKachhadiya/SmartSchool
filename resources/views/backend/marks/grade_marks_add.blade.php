...
<section class="content">
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="start_marks" class="form-control" required="">
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="end_marks" class="form-control" required="" >
	  </div>
	  </div>
	...
	<div class="col-md-4">
 	 ...
 	 <div class="form-group">
		...
		<div class="controls">
	 <input type="number" name="start_point" class="form-control" required="" >
	  </div>
	  </div>
...
<div class="col-md-4">
		...
		<div class="controls">
	 <input type="number" name="end_point" class="form-control" required="" >
	  </div>
	  </div>
