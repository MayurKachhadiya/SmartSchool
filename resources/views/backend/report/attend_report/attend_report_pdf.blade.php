...
<table id="customers">
  <tr>
    <td><h2>
  <?php $image_path = '/upload/sm.png'; ?>
  <img src="{{ public_path() . $image_path }}" width="200" height="200">

    </h2></td>
    <td><h2>SmartSchool surat</h2>
<p>School Address:Surat</p>
<p>Phone : 7077755432</p>
<p>Email : smartschool@gmail.com</p>
<p> <b> Attdenace Report </b> </p>
    </td> 
  </tr>
