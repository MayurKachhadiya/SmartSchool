...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('upload/sm.png') }}" style="width: 120px; height: 100px;">
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>SmartSchool</strong></h4>
  			<h6><strong>Surat India</strong></h6>
...
<thead>
  <tr>
    ...
    <th class="text-center">Subject</th> <!-- Write by nitesh -->
...
<tbody>
  @php
      ...
      $total_point = 0;
      //$sub_arr = (array)$subjs;
      //print_r(in_array(103,$sub_arr[0]));
...
@php
  ...
  foreach ($sub_arr as $sub_key => $sub_value) {
        if(in_array($mark->assign_subject_id, $sub_value)){
            $get_sub = $sub_value['name'];
        }
  }
  /* Write by Nitesh */
...
<tr>
  ...
  <td class="text-center">{{ $get_sub }}</td> <!-- write by nitesh -->
