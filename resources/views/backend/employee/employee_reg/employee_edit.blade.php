...
<section class="content">
	 ...
	 <form method="post" action="{{ route('update.employee.registration',$editData->id) }}" enctype="multipart/form-data">
		...
		<div class="controls">
	 <input type="text" name="name"    pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on alphabets only. ')"class="form-control" required="" value="{{ $editData->name }}" >
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="fname"  pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on alphabets only. ')" class="form-control" required="" value="{{ $editData->fname }}">
	  </div>
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="mname"  pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on alphabets only. ')" class="form-control" required="" value="{{ $editData->mname }}">
	  </div>
	  </div>
	...
	<div class="row"> <!-- 2nd Row -->
		...
		<div class="controls">
	 <input type="tel" maxlength="10" pattern="\d{10}" name="mobile" class="form-control" required="" value="{{ $editData->mobile }}" >
	  </div>
	  </div>
